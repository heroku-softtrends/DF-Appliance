...
using DemoDFAppliance.Models;
using Newtonsoft.Json;
using System.Net.Http.Headers;
using System.Text;

namespace DemoDFAppliance.Controllers
{
    public class ApplianceController : Controller
    {
        ...
        [HttpPost]
        [AllowAnonymous]
        public async Task<JsonResult> SendData(int distance)
        {
            try
            {
                using (var httpClient1 = new HttpClient())
                {
                    ...
                    eventRequest.appID = ConfigVars.Instance.AppID;
                    eventRequest.distance_to_beacon = distance;
